...
if($_GET['from_date'] && $_GET['to_date'] && $_GET['submit']=="Search"){
   $result = $app->getOrderReports($_SESSION['id'],$_SESSION['type_app'],$_GET['from_date'],$_GET['to_date'],$_GET['storeid']);
...
<div class="modal-content ">
  <div class="modal-header">
    <h4 class="modal-title"> <i class="fa fa-list-ol fa-5" aria-hidden="true"></i> Orders Report</li></h4>
  </div>
             ...
             <?php        
			   ...
			   if($k['id']){ 
                ...
                echo '<tr>
						 ...
						 <td>'.$k['order_date'].'</td>
						 <td class="no-print"><a href="vieworderdetails.php?id='.$id.'" target="_blank" class="no-print"><span class="label no-print"><button class="btn btn-primary no-print">View <i class="fa fa-eye" aria-hidden="true"></i></button></span></a>
						</td>
					  </tr>';
			   }
               }?>
