...
// If session is not set, redirect to index page.
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.php" class="logo">
                ...
                <span class="logo-mini"><img src="logo.png" height="50" width="50"></span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"><?php echo ucfirst($_SESSION['name']); ?> <i class="fa fa-caret-square-o-down fa-4"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        <?php echo ucfirst($_SESSION['name']).'<br>';?>
