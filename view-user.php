...
<div class="modal-content ">
    ...
    <div class="modal-footer">
        <a href="edit-user.php?id=<?php echo $userInfo['id']; ?>">
            <button type="button" class="btn btn-primary btn-lg  btn-success">
                <i class="fa fa-pencil-square fa-6" aria-hidden="true"></i> EDIT
            </button>
        </a>
        <a href="delete-user.php?id=<?php echo $userInfo['id']; ?>" onClick="return checkDelete()" class="btn btn-social-icon btn-google btn-lg">
