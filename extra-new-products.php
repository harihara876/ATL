...
function getAdminNewProducts($conn)
{
    ...
    $selectSQL = "SELECT
            `id`,
            `upc`,
            products_temp2.`created_on`,
			admin.`name`,
			products_temp2.phone
        FROM `products_temp2` 
		LEFT JOIN `admin` ON admin.`admin_id`=products_temp2.`storeadmin_id`
                                    ...
                                    foreach ($newProducts as $newProduct) {
                                        echo "<tr>
                                                ...
                                                if($_SESSION['type_app']  == 'ADMIN'){
                                                    ...
                                                    <a href='edit-new-product2.php?id={$newProduct["id"]}'>
                                                    ...
                                                    echo"
                                                    <a href='delete-new-product2.php?id={$newProduct["id"]}' class='btn btn-social-icon btn-google' onClick='return checkDelete()'>
